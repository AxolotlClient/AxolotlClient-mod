...
public class CreditsScreen extends Screen {
	...
	private class Credit extends ElementListWidget.Entry<Credit> {
		...
		public void render(GuiGraphics graphics, int index, int y, int x, int entryWidth, int entryHeight, int mouseX,
			...
			if (hovered || c.isFocused()) {
				io.github.axolotlclient.AxolotlClientConfig.util.DrawUtil.getInstance().outlineRect(graphics, x-100, y, 200, 20,
	...
	private class Overlay {
		...
		public void render(GuiGraphics graphics) {
			io.github.axolotlclient.AxolotlClientConfig.util.DrawUtil.getInstance().drawRect(graphics, x, y, width, height, Color.DARK_GRAY.withAlpha(127).getAsInt(), 10);
			io.github.axolotlclient.AxolotlClientConfig.util.DrawUtil.getInstance().outlineRect(graphics, x, y, width, height, Color.WHITE.getAsInt(), 10);
