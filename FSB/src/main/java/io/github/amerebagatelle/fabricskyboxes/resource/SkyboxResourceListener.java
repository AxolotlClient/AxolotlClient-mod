...
public class SkyboxResourceListener implements IdentifiableResourceReloadListener {
    ...
    public void reload(ResourceManager manager) {
        ...
        // load new skyboxes
        Collection<Identifier> resources = manager.getAllResources(new Identifier("fabricskyboxes", ("sky"+ (String name) -> name.endsWith(".json"))));
