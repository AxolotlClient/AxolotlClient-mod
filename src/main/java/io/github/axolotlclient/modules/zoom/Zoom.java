...
public class Zoom extends AbstractModule {
	...
	public void init() {
		...
		keyBinding = new KeyBinding("key.zoom", InputUtil.GLFW_KEY_C, "category.axolotlclient");
	...
	public static void setOptions() {
		originalSensitivity = MinecraftClient.getInstance().options.getMouseSensitivity().getValue();
	...
	private static void updateSensitivity() {
		if (decreaseSensitivity.get()) {
			MinecraftClient.getInstance().options.getMouseSensitivity().setValue(originalSensitivity / (divisor*divisor));
		}
	}

	public static void restoreOptions() {
		MinecraftClient.getInstance().options.getMouseSensitivity().setValue(originalSensitivity);
